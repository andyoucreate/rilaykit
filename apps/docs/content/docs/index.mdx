...
<Cards>
  ...
  <Card
    ...
    description="Native support for Standard Schema - use Zod, Yup, Joi and other validation libraries directly without adapters."
  />
</Cards>
...
For developers migrating from validation adapters, check out our [Standard Schema migration guide](/migration/standard-schema).